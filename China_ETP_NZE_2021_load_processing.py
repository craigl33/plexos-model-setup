...
exec(open(r'Z:\Python_functions\geo_functions_wrapper.py').read())
# %edit Z:\Python_functions\geo_functions_wrapper.py

""" define PLEXOS load processing functions """
exec(open(r'Z:\Python_functions\PLEXOS_load_processing_functions_wrapper.py').read())
# %edit Z:\Python_functions\PLEXOS_load_processing_functions_wrapper.py

r""" define geo functions - get_files, combine_shape_files, merge_raster, write_raster, create_geo_grid, create_ref_geo_grid
%edit Z:\Python_functions\geo_functions_wrapper.py
"""
exec(open(r'Z:\Python_functions\geo_functions_wrapper.py').read())
...
sds_2020_check = convert_raw_load_to_PLEXOS_inputs(
    sds_2020_demand, dem_path, SDS_2020_path, indexsheet='DSM_index_SDS_2020', hasAl=True
)

sds_2035_check = convert_raw_load_to_PLEXOS_inputs(
    sds_2035_demand, dem_path, SDS_2035_path, indexsheet='DSM_index_SDS_2035', hasAl=True
)
sds_2050_check = convert_raw_load_to_PLEXOS_inputs(
    sds_2050_demand, dem_path, SDS_2050_path, indexsheet='DSM_index_SDS_2050', hasAl=True
)

nze_2060_check = convert_raw_load_to_PLEXOS_inputs(
    nze_2060_demand, dem_path, NZE_2060_path, indexsheet='DSM_index_SDS_2050', hasAl=True
)
